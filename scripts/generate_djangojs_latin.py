"""Generate scripts/djangojs_latin.json for admin JavaScript (Serbian Latin)."""
...
L: dict[str, str] = {
    ...
    "Type into this box to filter down the list of available %s.": "Kucajte ovde da suzite listu dostupnih „%s“.",
    "Filter": "Filter",
    ...
    "Type into this box to filter down the list of selected %s.": "Kucajte ovde da suzite listu izabranih „%s“.",
    ...
    "You have unsaved changes on individual editable fields. If you run an action, your unsaved changes will be lost.": (
        "Imate nesačuvane izmene u poljima. Ako pokrenete akciju, nesačuvane izmene će biti izgubljene."
    ),
    "You have selected an action, but you haven’t saved your changes to individual fields yet. Please click OK to save. You’ll need to re-run the action.": (
        "Izabrali ste akciju, ali niste sačuvali izmene u poljima. Kliknite OK da sačuvate, zatim ponovo pokrenite akciju."
    ),
    "You have selected an action, and you haven’t made any changes on individual fields. You’re probably looking for the Go button rather than the Save button.": (
        "Izabrali ste akciju bez izmena u poljima. Verovatno vam treba dugme Primeni, a ne Sačuvaj."
    ),
    "Now": "Sada",
    "Midnight": "Ponoć",
    "6 a.m.": "6 ujutru",
    "Noon": "Podne",
    "6 p.m.": "18 časova",
    "Choose a Time": "Izaberite vreme",
    "Choose a time": "Izaberite vreme",
    "Cancel": "Otkaži",
    "Today": "Danas",
    "Choose a Date": "Izaberite datum",
    "Yesterday": "Juče",
    "Tomorrow": "Sutra",
    "January": "Januar",
    "February": "Februar",
...
PLURALS: dict[str, list[str]] = {
    ...
    "%(sel)s of %(cnt)s selected": [
        "%(sel)s od %(cnt)s izabrano",
        "%(sel)s od %(cnt)s izabrano",
        "%(sel)s od %(cnt)s izabrano",
    ],
    "Note: You are %s hour ahead of server time.": [
        "Napomena: vaše vreme je %s sat ispred servera.",
        "Napomena: vaše vreme je %s sata ispred servera.",
        "Napomena: vaše vreme je %s sati ispred servera.",
    ],
    "Note: You are %s hour behind server time.": [
        "Napomena: vaše vreme je %s sat iza servera.",
        "Napomena: vaše vreme je %s sata iza servera.",
        "Napomena: vaše vreme je %s sati iza servera.",
    ],
}

# Month abbreviations with msgctxt
...
def main() -> None:
    ...
    en = polib.pofile(
        ROOT / ".venv/Lib/site-packages/django/contrib/admin/locale/en/LC_MESSAGES/djangojs.po"
    )
    missing: list[str] = []
    for entry in en:
        if not entry.msgid:
        ...
        if entry.msgctxt and key in CONTEXT:
            continue
    ...
    OUT.write_text(
        json.dumps(
            {"single": L, "plural": PLURALS, "context": {f"{a}|{b}": v for (a, b), v in CONTEXT.items()}, "missing": missing},
            ensure_ascii=False,
            indent=2,
        ),
        encoding="utf-8",
