...
CHANGELIST_TITLES: dict[str, str] = {
    ...
    "shipping.shippingmethod": _("Select shipping method to change"),
...
ADD_LABELS: dict[str, str] = {
    ...
    "shipping.shippingmethod": _("Add shipping method"),
...
COUNT_LABELS: dict[str, tuple[str, str]] = {
    ...
    "shipping.shippingmethod": (_("shipping method"), _("shipping methods")),
